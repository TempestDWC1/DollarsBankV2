<%@page import="com.cognixia.jump.model.Customer"%>
<!DOCTYPE html>
<html>
	<head>
		...
		<div class='container'>
	        <form action="AccountServlet" method="POST">
	        	<div class="d-grid gap-2 col-6 mx-auto">
	        		<h1 class="display-2">Hello <%=user.getUsername()%></h1>
				  ...
				  <button type="submit" value="Info" name="Info" class="btn btn-primary bt-lg">Info</button>
				  <button type="submit" value="SignOut" name="SighOut" class="btn btn-primary bt-lg">Sign Out</button>
			  	</div>
	        </form>
	    </div>
